...
if (isset($_POST["kirim"])) {
    ...
    $insert_siswa = mysqli_query($conn, "INSERT INTO siswa (NIS, Nama, id_kelas)
    VALUES ('$NIS', '$Nama', '$id_kelas')");

    if ($insert_siswa) {
        echo "<script>alert('Berhasil membuat siswa')</script>";
        echo "<script>window.location='tabel_siswa.php'</script>";
    } else {
        echo "<script>alert('Gagal membuat siswa')</script>";
        echo "<script>window.history.back();</script>";
        // kembali ke halaman sebelumnya jika gagalS
    }
}
?>
